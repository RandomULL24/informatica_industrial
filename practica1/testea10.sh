...
# Scritp para la prueba del ejercicio10 de la Práctica 1 de Inf. Ind.
# Curso 18-19
...
ejecutaOK() {
    let PRUEBAS++
    magenta "Invocado con Argumentos: =$@="
...
_EOF_
ejecutaOK datosBooleanos2 5  20
