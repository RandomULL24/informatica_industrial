...
#define TITULO "Calefactor → id, nombre, encendido"
...
int main() {
  ...
  Calefactor* d1 = new Calefactor(12.3);
  {
    pruebas++;
    unsigned idEsp = 1;
  ...
  std::cout << "- Creamos un dispositivo"  << std::endl;
  Calefactor* d2 = new Calefactor(33.56);
  {
    pruebas++;
    unsigned idEsp = 2;
  ...
  std::cout << "- Creamos un dispositivo"  << std::endl;
  Calefactor* d3 = new Calefactor(11.96);
  {
    pruebas++;
    unsigned idEsp = 3;
  ...
  delete d3;
  std::cout << "- Creamos un dispositivo"  << std::endl;
  Calefactor* d4 = new Calefactor(143.8);
  {
    pruebas++;
    unsigned idEsp = 4;
