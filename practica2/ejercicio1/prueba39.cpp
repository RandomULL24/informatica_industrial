...
#define TITULO "ControladorONOFF → calculaEtapa, calculaComando situaciones especiales"
...
int main() {
  ...
  std::cout << "- Invocamos calcula comando con 0 pero sin consigna"
      << std::endl;
  {
    pruebas++;
  ...
  std::cout << "- Invocamos calcula comando con 1 pero sin consigna"
      << std::endl;
  {
    pruebas++;
  ...
  std::cout << "- Invocamos calcula comando con 0.5 pero sin consigna"
      << std::endl;
  {
    pruebas++;
