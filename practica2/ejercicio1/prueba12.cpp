...
#define TITULO "SensorNivel → id, nombre, encendido"
...
int main() {
  ...
  SensorNivel* d1 = new SensorNivel(12.3);
  {
    pruebas++;
    unsigned idEsp = 1;
  ...
  std::cout << "- Creamos un dispositivo"  << std::endl;
  SensorNivel* d2 = new SensorNivel(33.56);
  {
    pruebas++;
    unsigned idEsp = 2;
  ...
  std::cout << "- Creamos un dispositivo"  << std::endl;
  SensorNivel* d3 = new SensorNivel(11.96);
  {
    pruebas++;
    unsigned idEsp = 3;
  ...
  delete d3;
  std::cout << "- Creamos un dispositivo"  << std::endl;
  SensorNivel* d4 = new SensorNivel(143.8);
  {
    pruebas++;
    unsigned idEsp = 4;
