...
#define TITULO "SensorTemperatura → id, nombre, encendido"
...
int main() {
  ...
  SensorTemperatura* d1 = new SensorTemperatura(-12.3, 132.88);
  {
    pruebas++;
    unsigned idEsp = 1;
  ...
  std::cout << "- Creamos un dispositivo"  << std::endl;
  SensorTemperatura* d2 = new SensorTemperatura(-33.56, 209.2);
  {
    pruebas++;
    unsigned idEsp = 2;
  ...
  std::cout << "- Creamos un dispositivo"  << std::endl;
  SensorTemperatura* d3 = new SensorTemperatura(11.96, 22.3);
  {
    pruebas++;
    unsigned idEsp = 3;
  ...
  delete d3;
  std::cout << "- Creamos un dispositivo"  << std::endl;
  SensorTemperatura* d4 = new SensorTemperatura(143.8, 281.4);
  {
    pruebas++;
    unsigned idEsp = 4;
